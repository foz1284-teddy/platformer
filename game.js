...
let spritesLoaded = 0;
let totalSprites = Object.keys(sprites).length;
...
function checkAllSpritesLoaded() {
  ...
  if (spritesLoaded === totalSprites) {
    // Only show play button if title screen has been dismissed
...
const levels = [
  {
    ...
    hazards: [
      ...
      { x: 1400, y: 379, width: 80, height: 20, type: 'SAND' }
    ],
    zombies: [
  ...
  },
  {
    ...
    hazards: [
      { x: 500, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 700, y: 379, width: 150, height: 20, type: 'WATER' },
      { x: 900, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 1100, y: 379, width: 150, height: 20, type: 'LAVA' },
      { x: 1300, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1500, y: 379, width: 150, height: 20, type: 'WATER' },
      { x: 1700, y: 379, width: 100, height: 20, type: 'SAND' }
    ],
    zombies: [
  ...
  },
  {
    ...
    hazards: [
      { x: 400, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 500, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 600, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 700, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 800, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 900, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1000, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1100, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 1200, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1300, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1400, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1500, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 1600, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1700, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1800, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1900, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 2000, y: 379, width: 80, height: 20, type: 'SAND' }
    ],
    zombies: [
  ...
  },
  {
    ...
    hazards: [
      ...
      { x: 500, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 600, y: 379, width: 60, height: 20, type: 'WATER' },
      { x: 700, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 800, y: 379, width: 60, height: 20, type: 'LAVA' },
      { x: 900, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1000, y: 379, width: 60, height: 20, type: 'WATER' },
      { x: 1100, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1200, y: 379, width: 60, height: 20, type: 'LAVA' },
      { x: 1300, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1400, y: 379, width: 60, height: 20, type: 'WATER' },
      { x: 1500, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1600, y: 379, width: 60, height: 20, type: 'LAVA' },
      { x: 1700, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1800, y: 379, width: 60, height: 20, type: 'WATER' },
      { x: 1900, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 2000, y: 379, width: 60, height: 20, type: 'LAVA' },
      { x: 2100, y: 379, width: 80, height: 20, type: 'SAND' },
  ...
  },
  {
    ...
    hazards: [
      ...
      { x: 600, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 700, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 800, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 900, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1000, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1100, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 1200, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1300, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1400, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1500, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 1600, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1700, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1800, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1900, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 2000, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 2100, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 2200, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 2300, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 2400, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 2500, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 2600, y: 379, width: 100, height: 20, type: 'SAND' },
  ...
  },
  {
    ...
    hazards: [
      ...
      { x: 2300, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 2400, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 2500, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 2600, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 2700, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 2800, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 2900, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 3000, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 3100, y: 379, width: 80, height: 20, type: 'SAND' },
  ...
  },
  {
    ...
    spikes: [
      ...
      { x: 3600, y: 340, width: 20, height: 40 },
      { x: 3800, y: 340, width: 20, height: 40 },
      { x: 4000, y: 340, width: 20, height: 40 },
      { x: 4200, y: 340, width: 20, height: 40 }
    ],
    hazards: [
      { x: 500, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 700, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 900, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 1100, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1300, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 1500, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 1700, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 1900, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 2100, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 2300, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 2500, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 2700, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 2900, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 3100, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 3300, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 3500, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 3700, y: 379, width: 100, height: 20, type: 'LAVA' },
      { x: 3900, y: 379, width: 100, height: 20, type: 'WATER' },
      { x: 4100, y: 379, width: 100, height: 20, type: 'SAND' },
      { x: 4300, y: 379, width: 100, height: 20, type: 'LAVA' }
    ],
    zombies: [
      { x: 300, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 300, endX: 500 },
      { x: 600, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 600, endX: 800 },
      { x: 900, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 900, endX: 1100 },
      { x: 1200, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 1200, endX: 1400 },
      { x: 1500, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 1500, endX: 1700 },
      { x: 1800, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 1800, endX: 2000 },
      { x: 2100, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 2100, endX: 2300 },
      { x: 2400, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 2400, endX: 2600 },
      { x: 2700, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 2700, endX: 2900 },
      { x: 3000, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 3000, endX: 3200 },
      { x: 3300, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 3300, endX: 3500 },
      { x: 3600, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 3600, endX: 3800 },
      { x: 3900, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 3900, endX: 4100 },
      { x: 4200, y: 350, width: 30, height: 30, speed: 3, direction: 1, startX: 4200, endX: 4400 }
    ],
    platforms: [
      { x: 200, y: 300, width: 100, height: 20 },
      { x: 450, y: 260, width: 80, height: 20 },
      { x: 750, y: 320, width: 60, height: 20 },
      { x: 1050, y: 280, width: 100, height: 20 },
      { x: 1350, y: 240, width: 80, height: 20 },
      { x: 1650, y: 320, width: 60, height: 20 },
      { x: 1950, y: 280, width: 100, height: 20 },
      { x: 2250, y: 240, width: 80, height: 20 },
      { x: 2550, y: 320, width: 60, height: 20 },
      { x: 2850, y: 280, width: 100, height: 20 },
      { x: 3150, y: 240, width: 80, height: 20 },
      { x: 3450, y: 320, width: 60, height: 20 },
      { x: 3750, y: 280, width: 100, height: 20 },
      { x: 4050, y: 240, width: 80, height: 20 },
      { x: 4350, y: 300, width: 100, height: 20 }
    ],
    bouncingPlatforms: [
      { x: 350, y: 180, width: 100, height: 20, bounceForce: -26 },
      { x: 800, y: 160, width: 80, height: 20, bounceForce: -28 },
      { x: 1250, y: 140, width: 100, height: 20, bounceForce: -30 },
      { x: 1700, y: 120, width: 80, height: 20, bounceForce: -32 },
      { x: 2150, y: 100, width: 100, height: 20, bounceForce: -34 },
      { x: 2600, y: 80, width: 80, height: 20, bounceForce: -36 },
      { x: 3050, y: 60, width: 100, height: 20, bounceForce: -38 },
      { x: 3500, y: 40, width: 80, height: 20, bounceForce: -40 },
      { x: 3950, y: 20, width: 100, height: 20, bounceForce: -42 }
    ],
    collectibles: [
      { x: 300, y: 260, type: 'COIN' },
      { x: 500, y: 220, type: 'COIN' },
      ...
      { x: 3000, y: 200, type: 'COIN' },
      { x: 3300, y: 240, type: 'GEM' },
      { x: 3600, y: 200, type: 'KEY' },
      { x: 3900, y: 240, type: 'GEM' },
      { x: 4200, y: 200, type: 'COIN' }
    ],
    secretAreas: [
      {
        x: 2800,
        ...
        requiresKey: true,
        collectibles: [
          { x: 2900, y: 100, type: 'GEM' },
          { x: 2950, y: 100, type: 'GEM' },
          { x: 3000, y: 100, type: 'GEM' },
          { x: 3050, y: 100, type: 'GEM' },
          { x: 3100, y: 100, type: 'GEM' },
          { x: 2925, y: 150, type: 'COIN' },
          { x: 2975, y: 150, type: 'COIN' },
          { x: 3025, y: 150, type: 'COIN' },
          { x: 3075, y: 150, type: 'COIN' },
          { x: 3125, y: 150, type: 'COIN' }
        ]
      }
    ]
  },
  {
    ...
    spikes: [
      ...
      { x: 4000, y: 340, width: 20, height: 40 },
      { x: 4200, y: 340, width: 20, height: 40 },
      { x: 4400, y: 340, width: 20, height: 40 },
      { x: 4600, y: 340, width: 20, height: 40 },
      { x: 4800, y: 340, width: 20, height: 40 }
    ],
    hazards: [
      { x: 500, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 700, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 900, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 1100, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1300, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 1500, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 1700, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 1900, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 2100, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 2300, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 2500, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 2700, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 2900, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 3100, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 3300, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 3500, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 3700, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 3900, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 4100, y: 379, width: 80, height: 20, type: 'SAND' },
      { x: 4300, y: 379, width: 80, height: 20, type: 'LAVA' },
      { x: 4500, y: 379, width: 80, height: 20, type: 'WATER' },
      { x: 4700, y: 379, width: 80, height: 20, type: 'SAND' }
    ],
    zombies: [
      { x: 300, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 300, endX: 500 },
      { x: 600, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 600, endX: 800 },
      { x: 900, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 900, endX: 1100 },
      { x: 1200, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 1200, endX: 1400 },
      { x: 1500, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 1500, endX: 1700 },
      { x: 1800, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 1800, endX: 2000 },
      { x: 2100, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 2100, endX: 2300 },
      { x: 2400, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 2400, endX: 2600 },
      { x: 2700, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 2700, endX: 2900 },
      { x: 3000, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 3000, endX: 3200 },
      { x: 3300, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 3300, endX: 3500 },
      { x: 3600, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 3600, endX: 3800 },
      { x: 3900, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 3900, endX: 4100 },
      { x: 4200, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 4200, endX: 4400 },
      { x: 4500, y: 350, width: 30, height: 30, speed: 3.2, direction: 1, startX: 4500, endX: 4700 }
    ],
    platforms: [
      { x: 200, y: 300, width: 100, height: 20 },
      { x: 450, y: 260, width: 80, height: 20 },
      ...
      { x: 3750, y: 280, width: 100, height: 20 },
      { x: 4050, y: 240, width: 80, height: 20 },
      { x: 4350, y: 320, width: 60, height: 20 },
      { x: 4650, y: 280, width: 100, height: 20 }
    ],
    bouncingPlatforms: [
      { x: 350, y: 180, width: 100, height: 20, bounceForce: -28 },
      { x: 800, y: 160, width: 80, height: 20, bounceForce: -30 },
      { x: 1250, y: 140, width: 100, height: 20, bounceForce: -32 },
      { x: 1700, y: 120, width: 80, height: 20, bounceForce: -34 },
      { x: 2150, y: 100, width: 100, height: 20, bounceForce: -36 },
      { x: 2600, y: 80, width: 80, height: 20, bounceForce: -38 },
      { x: 3050, y: 60, width: 100, height: 20, bounceForce: -40 },
      { x: 3500, y: 40, width: 80, height: 20, bounceForce: -42 },
      { x: 3950, y: 20, width: 100, height: 20, bounceForce: -44 },
      { x: 4400, y: 0, width: 80, height: 20, bounceForce: -46 }
    ],
    collectibles: [
      { x: 300, y: 260, type: 'COIN' },
      { x: 500, y: 220, type: 'COIN' },
      ...
      { x: 3600, y: 200, type: 'COIN' },
      { x: 3900, y: 240, type: 'GEM' },
      { x: 4200, y: 200, type: 'KEY' },
      { x: 4500, y: 240, type: 'GEM' },
      { x: 4800, y: 200, type: 'COIN' }
    ],
    secretAreas: [
      {
        x: 3200,
        ...
        requiresKey: true,
        collectibles: [
          { x: 3300, y: 100, type: 'GEM' },
          { x: 3350, y: 100, type: 'GEM' },
          { x: 3400, y: 100, type: 'GEM' },
          { x: 3450, y: 100, type: 'GEM' },
          { x: 3500, y: 100, type: 'GEM' },
          { x: 3550, y: 100, type: 'GEM' },
          { x: 3325, y: 150, type: 'COIN' },
          { x: 3375, y: 150, type: 'COIN' },
          { x: 3425, y: 150, type: 'COIN' },
          { x: 3475, y: 150, type: 'COIN' },
          { x: 3525, y: 150, type: 'COIN' },
          { x: 3575, y: 150, type: 'COIN' }
        ]
      }
    ]
  },
  {
    ...
    spikes: [
      ...
      { x: 4600, y: 340, width: 20, height: 40 },
      { x: 4800, y: 340, width: 20, height: 40 },
      { x: 5000, y: 340, width: 20, height: 40 },
      { x: 5200, y: 340, width: 20, height: 40 }
    ],
    hazards: [
      { x: 500, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 700, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 900, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 1100, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 1300, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 1500, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 1700, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 1900, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 2100, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 2300, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 2500, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 2700, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 2900, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 3100, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 3300, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 3500, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 3700, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 3900, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 4100, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 4300, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 4500, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 4700, y: 379, width: 120, height: 20, type: 'SAND' },
      { x: 4900, y: 379, width: 120, height: 20, type: 'LAVA' },
      { x: 5100, y: 379, width: 120, height: 20, type: 'WATER' },
      { x: 5300, y: 379, width: 120, height: 20, type: 'SAND' }
    ],
    zombies: [
      { x: 300, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 300, endX: 500 },
      { x: 600, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 600, endX: 800 },
      { x: 900, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 900, endX: 1100 },
      { x: 1200, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 1200, endX: 1400 },
      { x: 1500, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 1500, endX: 1700 },
      { x: 1800, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 1800, endX: 2000 },
      { x: 2100, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 2100, endX: 2300 },
      { x: 2400, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 2400, endX: 2600 },
      { x: 2700, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 2700, endX: 2900 },
      { x: 3000, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 3000, endX: 3200 },
      { x: 3300, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 3300, endX: 3500 },
      { x: 3600, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 3600, endX: 3800 },
      { x: 3900, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 3900, endX: 4100 },
      { x: 4200, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 4200, endX: 4400 },
      { x: 4500, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 4500, endX: 4700 },
      { x: 4800, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 4800, endX: 5000 },
      { x: 5100, y: 350, width: 30, height: 30, speed: 3.5, direction: 1, startX: 5100, endX: 5300 }
    ],
    platforms: [
      { x: 200, y: 300, width: 100, height: 20 },
      { x: 450, y: 260, width: 80, height: 20 },
      ...
      { x: 4350, y: 320, width: 60, height: 20 },
      { x: 4650, y: 280, width: 100, height: 20 },
      { x: 4950, y: 240, width: 80, height: 20 },
      { x: 5250, y: 300, width: 100, height: 20 }
    ],
    bouncingPlatforms: [
      { x: 350, y: 180, width: 100, height: 20, bounceForce: -30 },
      { x: 800, y: 160, width: 80, height: 20, bounceForce: -32 },
      { x: 1250, y: 140, width: 100, height: 20, bounceForce: -34 },
      { x: 1700, y: 120, width: 80, height: 20, bounceForce: -36 },
      { x: 2150, y: 100, width: 100, height: 20, bounceForce: -38 },
      { x: 2600, y: 80, width: 80, height: 20, bounceForce: -40 },
      { x: 3050, y: 60, width: 100, height: 20, bounceForce: -42 },
      { x: 3500, y: 40, width: 80, height: 20, bounceForce: -44 },
      { x: 3950, y: 20, width: 100, height: 20, bounceForce: -46 },
      { x: 4400, y: 0, width: 80, height: 20, bounceForce: -48 },
      { x: 4850, y: -20, width: 100, height: 20, bounceForce: -50 }
    ],
    collectibles: [
      { x: 300, y: 260, type: 'COIN' },
      { x: 500, y: 220, type: 'COIN' },
      ...
      { x: 4200, y: 200, type: 'COIN' },
      { x: 4500, y: 240, type: 'GEM' },
      { x: 4800, y: 200, type: 'KEY' },
      { x: 5100, y: 240, type: 'GEM' },
      { x: 5400, y: 200, type: 'COIN' }
    ],
    secretAreas: [
      {
        x: 3600,
        ...
        requiresKey: true,
        collectibles: [
          { x: 3700, y: 100, type: 'GEM' },
          { x: 3750, y: 100, type: 'GEM' },
          { x: 3800, y: 100, type: 'GEM' },
          { x: 3850, y: 100, type: 'GEM' },
          { x: 3900, y: 100, type: 'GEM' },
          { x: 3950, y: 100, type: 'GEM' },
          { x: 4000, y: 100, type: 'GEM' },
          { x: 3725, y: 150, type: 'COIN' },
          { x: 3775, y: 150, type: 'COIN' },
          { x: 3825, y: 150, type: 'COIN' },
          { x: 3875, y: 150, type: 'COIN' },
          { x: 3925, y: 150, type: 'COIN' },
          { x: 3975, y: 150, type: 'COIN' },
          { x: 4025, y: 150, type: 'COIN' }
        ]
      }
    ]
  }
...
const characterSkins = {
  ...
  silver: {
    name: 'Silver Warrior',
    unlocked: false,
    sprite: 'player_silver'
  },
  rainbow: {
    name: 'Rainbow Champion',
    unlocked: false,
    sprite: 'player_rainbow'
  }
};

// Load all skin sprites (defined after characterSkins so it can access it)
function loadSkinSprites() {
  // Add skin sprites to sprites object and update total count
  Object.keys(characterSkins).forEach(skinId => {
    const skin = characterSkins[skinId];
    if (skin.sprite && skin.sprite !== 'player' && !sprites[skin.sprite]) {
      sprites[skin.sprite] = new Image();
      sprites[skin.sprite].onload = checkAllSpritesLoaded;
      sprites[skin.sprite].src = `sprites/${skin.sprite}.svg`;
      totalSprites++;
    }
  });
}
...
function gameLoop() {
  ...
  if (!gameWon && !gameLost) {
    // Reset player speed to normal (will be modified if in sand)
    player.speed = 2;
        ...
        if (player.x < hazard.x + hazard.width &&
          ...
          if (!player.invulnerable) {
            if (hazard.type === 'WATER') {
              ...
              // Sinking sand - pulls player down and slows movement
...
function startGame() {
  ...
  const currentSkin = getCurrentSkin();
  const playerSprite = sprites[currentSkin.sprite] || sprites.player;
  ctx.drawImage(playerSprite, 50, 350, 30, 30);
}
...
function setupTitleScreen() {
  ...
  const titleScreenButton = document.getElementById('titleScreenButton');
  ...
  if (titleScreenButton) {
    titleScreenButton.addEventListener('click', () => {
      ...
      // Mark title screen as dismissed
      titleScreenDismissed = true;
      
      // Check if sprites are already loaded - if so, show play button
      if (spritesLoaded === totalSprites) {
        document.getElementById('playButton').style.display = 'block';
        startGame();
      }
    ...
    titleScreenButton.addEventListener('touchend', (e) => {
      e.preventDefault();
      titleScreenButton.click();
    });
  }
}
...
document.addEventListener('click', () => {
  ...
  if (!audioInitialized && titleScreenDismissed) {
    initializeAudio();
  }
});
...
const shop = {
  chests: [
    ...
    },
    {
      ...
      rewards: {
        coins: [50, 100],
        gems: [5, 15],
        skins: ['gold', 'purple', 'orange', 'silver']
      }
    },
    {
      id: 'heroic',
  ...
  openChest(chestId) {
    ...
    // Chance for skin reward (higher chance for heroic and godly chests)
    const skinChance = chest.id === 'godly' ? 1.0 : (chest.id === 'heroic' ? 0.8 : 0.3);
